...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'bar' | 'line' | 'heatmap' | 'table' | 'waterfall' | 'bubble' | 'competitive-intelligence' | 'customer-intelligence' | 'customer-intelligence-database' | 'ci-propositions'>('bar')
  ...
  const chartIdToTab: Record<string, typeof activeTab> = {
    ...
    'ci-proposition-1': 'ci-propositions',
    'ci-proposition-2': 'ci-propositions',
    'ci-proposition-3': 'ci-propositions'
  }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Global Epitaxial Wafer Market'}
              </h2>
            </div>
          </div>
        ...
        <div className="mb-6 bg-yellow-50 border border-yellow-300 rounded-lg px-4 py-3 flex items-center gap-2">
          ...
          <span className="text-yellow-800 text-sm">All the data in this dashboard is demo data. No real world data is related to this.</span>
        </div>
                  ...
                  <nav className="flex items-center -mb-px">
                    ...
                    {viewMode === 'tabs' && (
                      <>
                        ...
                        {isChartVisible('ci-proposition-1') && (
                          <button
